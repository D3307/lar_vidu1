...
<body>
    ...
    @php
        ...
        $hiddenRoutes = ['accounts.edit', 'login', 'register', 'customer.cart', 'customer.checkout', 'customer.about', 'customer.contact', 'orders.index', 'orders.show', 'wishlist', 'customer.chat',  'review.create', 'review.store'];
    @endphp
